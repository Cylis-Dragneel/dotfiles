...
;;; Commentary:
;;; Euphoria theme created by Calix in 2024
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-footnote  ((,class (:underline t :foreground ,bg4))))
   `(org-link ((,class (:underline t :foreground ,builtin ))))
